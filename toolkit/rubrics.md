...
| Competency — "The student can…" | Not Yet | Approaching | Proficient | Advanced |
|---|---|---|---|---|
...
*These rubrics are designed to sit alongside your existing grading, not replace it. If a student aces the content but scores Not Yet on Initiative, that gap is worth naming — in the next classroom or the next job, the content won't matter if they can't get themselves started.*
