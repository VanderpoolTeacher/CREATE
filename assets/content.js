...
window.CREATE_CONTENT = {
  ...
  unitsIntro:
    "These units are optional. They are written for teachers who have room to restructure a unit or carve out dedicated practice time. If that's not where you are right now, the weave-in strategies are the primary path — and they work. Come back here when the timing is right.",
  units: [
    {
